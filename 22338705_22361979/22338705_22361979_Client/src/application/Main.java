...
public class Main extends Application {
	...
	public static final int PORT = 4523;
	...
	public void initialize() {
		...
		displaySchedule.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				moduleCode = enterModuleCode1.getText();
				try {
					sendModuleDataToDisplay("DISPLAY_SCHEDULE", moduleCode);
				} catch (IncorrectActionException e) {
					System.out.println(e.IncorrectActionMessage());
	...
	private void sendModuleDataToDisplay(String operation, String moduleCode) throws IncorrectActionException {
	    try {
